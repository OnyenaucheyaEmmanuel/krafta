...
def checkout(request):
    ...
    try:
        ...
        messages.success(request, f'Checkout Suceesful')
    except:
...
def forms(request):
    if request.method == "POST":
        ...
        if product_form.is_valid():
            ...
            return redirect('/ecommerce/forms')
            # messages.success(request, ('Your product was successfully added!'))
    ...
    return render(request=request, template_name="stores/forms.html", context={'product_form':product_form, 'product':product})
